...
// my code ...
setTimeout('initRgbaster()',500);
function initRgbaster()
{
  var img = document.getElementById('rgbaster');
  RGBaster.colors(img, {
    ...
    success: function(payload) {
      ...
      $("#rgbaster-container").css("background-color", payload.dominant);
      $("#rgbaster").css("border-color", payload.secondary);
    }
  });
}